...
let ServicioService = class ServicioService {
    ...
    async createServicio(servicio) {
        ...
        if (servicioFound) {
            return new common_1.HttpException('servicio already exists', common_1.HttpStatus.CONFLICT);
        }
    ...
    async getServicio(id) {
        ...
        if (!servicioFound) {
            return new common_1.HttpException('servicio not found', common_1.HttpStatus.NOT_FOUND);
        }
