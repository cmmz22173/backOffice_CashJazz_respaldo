...
let EmpleadoService = class EmpleadoService {
    ...
    async createEmpleado(empleado) {
        ...
        if (empleadoFound) {
            return new common_1.HttpException('Empleado already exists', common_1.HttpStatus.CONFLICT);
        }
    ...
    async getEmpleados() {
        ...
        if (!empleadoFound) {
            return new common_1.HttpException('Empleado not found', common_1.HttpStatus.NOT_FOUND);
        }
