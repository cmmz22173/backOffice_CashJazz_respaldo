          ...
          <Box sx={{ width: '100%' }}>
              ...
              <TabPanel value={value} index={0}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={3}>
                  <Typography variant='h6'>Primer nombre</Typography>
                        <Typography>{empleado && empleado.primerNombre}</Typography>
                      
                    </Grid>

                    <Grid item xs={3}>
                    <Typography variant='h6'>Segundo nombre</Typography>
                        <Typography>{empleado && empleado.segundoNombre}</Typography>
                    </Grid>

                    <Grid item xs={3}>
                    <Typography variant='h6'>Primer apellido</Typography>
                        <Typography>{empleado && empleado.primerApellido}</Typography>
                    </Grid>

                    <Grid item xs={3}>
                    <Typography variant='h6'>Segundo apellido</Typography>
                        <Typography>{empleado && empleado.segundoApellido}</Typography>
                    </Grid>

                    <Grid item xs={3}>
                    <Typography variant='h6'>DNI</Typography>
                        <Typography>{empleado && empleado.dni}</Typography>
                    </Grid>

                    <Grid item xs={3} >
                    <Typography variant='h6'>Genero</Typography>
                        <Typography>{empleado && empleado.genero}</Typography>
                    </Grid>

                
                    <Grid item xs={3}>
                    <Typography variant='h6'>Correo</Typography>
                        <Typography>{empleado && empleado.correo}</Typography>
                    </Grid>

                    <Grid item xs={3}>
                    <Typography variant='h6'>Telefono</Typography>
                        <Typography>{empleado && empleado.celular}</Typography>
                    </Grid>
                   
                    <Grid item xs={12} sx={{mt:"0.8rem"}} textAlign={"end"}>
